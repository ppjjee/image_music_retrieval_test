...
def home():
    ...
    with header:
        ...
        st.button('Agree, Start', on_click=CB_MoodImagePageButton)
                ...
                with show_tags:
                    if len(final_tag) == 3:
                        ...
                        if st.checkbox("Do you want to move to the next page?", key='check1'):
                            ...
                            st.button('NEXT', on_click=CB_MoodMusicPageButton)
...
def page_2():
    ...
    with st.container():
        ...
        if st.checkbox("Do you want to move to the next page?", key='check4'):
            ...
            st.experimental_set_query_params(path=save_path) 
            st.button('NEXT', on_click=CB_ThemeImagePageButton)
            ...
            if clicked >= 0:
                ...
                with show_tags:
                    if len(final_tag) == 3:
                        ...
                        with tc1:
                            change1 = st.selectbox("Select keyword", t1, key='tc4')
                        
                        with tc2:
                            change2 = st.selectbox("Select keyword", t2, key='tc5')
                        
                        with tc3:
                            change3 = st.selectbox("Select keyword", t3, key='tc6')


                        # save results
                        if st.checkbox("Do you want to move to the next page?", key='check5'):
                            results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': final_tag[1][0], 'Tag3': final_tag[2][0], 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                            if not os.path.exists(save_path):
                                data = {}
                                data['submits'] = []
                            ...
                            st.experimental_set_query_params(path=save_path)                               
                            st.button('NEXT', on_click=CB_ThemeMusicPageButton)
                        ...
                        # save results
                        if st.checkbox("Do you want to move to the next page?", key='check6'):
                            results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': final_tag[1][0], 'Tag3': '-', 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                            if not os.path.exists(save_path):
                                data = {}
                                data['submits'] = []
                        ...
                        ## save results
                        if st.checkbox("Do you want to move to the next page?", key='check7'):
                            results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': '-', 'Tag3': '-', 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                            if not os.path.exists(save_path):
                                data = {}
                                data['submits'] = []
...
def music_retrieval2():
    input_file = '/nas2/epark/mtg-jamendo-dataset/data/autotagging_moodtheme.tsv'
    tracks, tags, extra = commons.read_file(input_file)

    find_tag_list = []
    save_path = st.experimental_get_query_params()['path'][0]
    print("path 4: " + save_path)
    music_tag = TagLoad(save_path)
    for i in music_tag:
        p = tags['mood/theme'][i]
        q = list(p)
...
## streamlit display codes
def page_4():
    random_all, save_path = music_retrieval2()
    st.title('Image to Music Retrieval')
    st.subheader("Now, we recommend a music list that matches the image!")
    st.write('-----')
    st.text("🎧 Please enjoy the music and answer the questions below. 🎧")
    ...
    with st.container():
        satis_result = st.slider('Do you satisfy with the recommended music?', min_value=0, max_value=100, value=50, step=1)
        st.write('-----')
        if st.checkbox("Do you want to move to the next page?", key='check8'):
            with open(save_path, "r") as json_file:
                results_B = {'Music Satisfaction': satis_result}
                data = json.load(json_file)
                data['submits'][-1].update(results_B)
            ...
            st.experimental_set_query_params(path=save_path) 
            button = st.button('NEXT', on_click=CB_MoodImagePageButton2)




## ------------------ for Mood Image Retrieval 2 ------------------------ 
def get_result_dir():
    path = os.getcwd() + "/results"
    isExists = os.path.exists(path)
    if not isExists:
            ...
            if clicked >= 0:
                ...
                with show_tags:
                    if len(final_tag) == 3:
                        ...
                        with tc7:
                            change1 = st.selectbox("Select keyword", t1, key='tc7')
                        
                        with tc8:
                            change2 = st.selectbox("Select keyword", t2, key='tc8')
                        
                        with tc9:
                            change3 = st.selectbox("Select keyword", t3, key='tc9')


                        # save results
                        if st.checkbox("Do you want to move to the next page?", key='check9'):
                            results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': final_tag[1][0], 'Tag3': final_tag[2][0], 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                            if not os.path.exists(save_path):
                                data = {}
                                data['submits'] = []
                            ...
                            st.experimental_set_query_params(path=save_path)                               
                            st.button('NEXT', on_click=CB_MoodMusicPageButton2)
                        ...
                        # save results
                        if st.checkbox("Do you want to move to the next page?", key='check10'):
                            if not os.path.exists(save_path):
                                results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': final_tag[1][0], 'Tag3': '-', 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                                data = {}
                                data['submits'] = []
                        ...
                        # save results
                        if st.checkbox("Do you want to move to the next page?", key='check11'):
                            results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': '-', 'Tag3': '-', 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                            if not os.path.exists(save_path):
                                data = {}
                                data['submits'] = []
...
## streamlit display codes
def page_6():
    random_all, save_path = music_retrieval3()
    st.title('Image to Music Retrieval')
    st.subheader("Now, we recommend a music list that matches the image!")
    st.write('-----')
    st.text("🎧 Please enjoy the music and answer the questions below. 🎧")
    ...
    with st.container():
        satis_result = st.slider('Do you satisfy with the recommended music?', min_value=0, max_value=100, value=50, step=1)    
        st.write('-----')
        if st.checkbox("Do you want to move to the next page?", key='check12'):
            with open(save_path, "r") as json_file:
                results_B = {'Music Satisfaction': satis_result}
                data = json.load(json_file)
                data['submits'][-1].update(results_B)
            ...
            st.experimental_set_query_params(path=save_path) 
            button = st.button('NEXT', on_click=CB_ThemeImagePageButton2)
            ...
            if clicked >= 0:
                ...
                with show_tags:
                    if len(final_tag) == 3:
                        ...
                        with tc10:
                            change1 = st.selectbox("Select keyword", t1, key='tc11')
                        
                        with tc11:
                            change2 = st.selectbox("Select keyword", t2, key='tc12')
                        
                        with tc12:
                            change3 = st.selectbox("Select keyword", t3, key='tc13')


                        # save results
                        if st.checkbox("Do you want to move to the next page?", key='check13'):
                            results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': final_tag[1][0], 'Tag3': final_tag[2][0], 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                            if not os.path.exists(save_path):
                                data = {}
                                data['submits'] = []
                            ...
                            st.experimental_set_query_params(path=save_path)                               
                            st.button('NEXT', on_click=CB_ThemeMusicPageButton2)
                        ...
                        with tc10:
                            change1 = st.selectbox("Select keyword", t1, key='tc10')
                        
                        with tc11:
                            change2 = st.selectbox("Select keyword", t2, key='tc11')
                        
                        with tc12:
                            change3 = st.selectbox("Select keyword", t3, key='tc12')
                        
                        
                        # save results
                        if st.checkbox("Do you want to move to the next page?", key='check14'):
                            results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': final_tag[1][0], 'Tag3': '-', 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                            if not os.path.exists(save_path):
                                data = {}
                                data['submits'] = []
                        ...
                        ## save results
                        if st.checkbox("Do you want to move to the next page?", key='check15'):
                            results_B = {'Image': f"{str(int(clicked)+1)}", 'Tag1': final_tag[0][0], 'Tag2': '-', 'Tag3': '-', 'Tags Satisfaction': satis_result, 'Change Tag1': change1, 'Change Tag2': change2, 'Change Tag3': change3}
                            if not os.path.exists(save_path):
                                data = {}
                                data['submits'] = []
...
## streamlit display codes
def page_8():
    random_all, save_path = music_retrieval4()
    music_tags = st.container()
    st.title('Image to Music Retrieval')
    st.subheader("Now, we recommend a music list that matches the image!")
    st.write('-----')
    ...
    with st.container():
        satis_result = st.slider('Do you satisfy with the recommended music?', min_value=0, max_value=100, value=50, step=1)
        st.write('-----')
        if st.checkbox("Do you want to move to the next page?", key='check16'):
            with open(save_path, "r") as json_file:
                results_B = {'Music Satisfaction': satis_result}
                data = json.load(json_file)
                data['submits'][-1].update(results_B)
            ...
            st.experimental_set_query_params(path=save_path) 
            button = st.button('NEXT', on_click=CB_SurveyPageButton)
...
def page_9():
    ...
    with survey:
        ...
        if st.checkbox("Do you want to move to the next page?", key='fin'):
            ...
            st.button('END', on_click=CB_FinishPageButton)  
## ------------------ for Survey ------------------------ 
def page_9():
    save_path = st.experimental_get_query_params()['path'][0]
    print("path 5: " + save_path)
